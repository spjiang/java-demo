package main.spjiang.springboot.rabbitmq.listener;

import main.spjiang.springboot.rabbitmq.bean.Order;
import main.spjiang.springboot.rabbitmq.config.RabbitmqConfig;
...
/**
 * Package: main.spjiang.springboot.listener
 *
 * @description:
